...
//         {/* Features Section */}
//         <section id="features" className="py-20 bg-[#262323]">
//   <div className="container mx-auto px-4">
//     <div className="text-center mb-16">
//       <h2 className="text-4xl font-bold text-white mb-4">
//         <span className="relative inline-block px-2">
//           Why Choose SponSync
//           <span className="absolute inset-x-0 bottom-2 bg-gradient-to-r from-[#ff3131]/30 to-[#ff914d]/30 -z-10 h-4"></span>
//         </span>
//       </h2>
...
//       {/* For Colleges Card */}
//       <div className="relative group">
//         <div className="absolute inset-0 bg-gradient-to-br from-[#ff3131] to-[#ff914d] rounded-xl blur opacity-30 group-hover:opacity-40 transition duration-300 transform group-hover:scale-105"></div>
//         <div className="relative bg-[#313030] rounded-xl shadow-xl p-8 border border-[#414040] backdrop-filter backdrop-blur-sm hover:translate-y-[-5px] transition-all duration-300">
//           <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[#ff3131] to-[#ff914d] flex items-center justify-center mb-6 shadow-lg">
...
//           <p className="text-gray-300 mb-6">Showcase your events to potential sponsors and manage packages effortlessly</p>
          
//           <ul className="space-y-3">
//             {["Create customizable sponsorship packages", 
//               "Gain visibility to corporate sponsors", 
//               "Track sponsorship fulfillment", 
//               "Simplify sponsor communication"].map((feature, i) => (
//               <li key={i} className="flex items-start">
//                 <div className="h-5 w-5 mt-0.5 mr-3 flex-shrink-0 rounded-full bg-gradient-to-br from-[#ff3131] to-[#ff914d] flex items-center justify-center">
...
//             <a href="#" className="inline-flex items-center text-[#ff914d] hover:text-white group">
...
//         <div className="absolute inset-0 bg-gradient-to-br from-[#ff3131] to-[#ff914d] rounded-xl blur opacity-30 group-hover:opacity-40 transition duration-300 transform group-hover:scale-105"></div>
//         <div className="relative bg-[#313030] rounded-xl shadow-xl p-8 border border-[#414040] backdrop-filter backdrop-blur-sm hover:translate-y-[-5px] transition-all duration-300">
//           <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[#ff914d] to-[#ff3131] flex items-center justify-center mb-6 shadow-lg">
//             <svg className="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//               <path d="M3 21h18M9 8h1m-1 4h1m-1 4h1m4-8h1m-1 4h1m-1 4h1m5-16H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V6a2 2 0 00-2-2z"></path>
//             </svg>
//           </div>
          
//           <h3 className="text-2xl font-bold text-white mb-4">For Companies</h3>
//           <p className="text-gray-300 mb-6">Discover college events that align with your brand and sponsorship goals</p>
          
//           <ul className="space-y-3">
//             {["Browse events by location and type", 
//               "Compare sponsorship packages", 
//               "Track ROI on sponsorships", 
//               "Receive verification reports"].map((feature, i) => (
//               <li key={i} className="flex items-start">
//                 <div className="h-5 w-5 mt-0.5 mr-3 flex-shrink-0 rounded-full bg-gradient-to-br from-[#ff914d] to-[#ff3131] flex items-center justify-center">
//                   <svg className="h-3 w-3 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
//                     <polyline points="20 6 9 17 4 12"></polyline>
//                   </svg>
//                 </div>
...
//       {/* Verified by SPOCs Card */}
//       <div className="relative group">
//         <div className="absolute inset-0 bg-gradient-to-br from-[#ff3131] to-[#ff914d] rounded-xl blur opacity-30 group-hover:opacity-40 transition duration-300 transform group-hover:scale-105"></div>
//         <div className="relative bg-[#313030] rounded-xl shadow-xl p-8 border border-[#414040] backdrop-filter backdrop-blur-sm hover:translate-y-[-5px] transition-all duration-300">
//           <div className="h-16 w-16 rounded-full bg-gradient-to-br from-[#ff3131] via-[#ff7040] to-[#ff914d] flex items-center justify-center mb-6 shadow-lg">
//             <svg className="h-8 w-8 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//               <path d="M20 7L9 18l-5-5M12 1v7l2 2"></path>
//             </svg>
//           </div>
          
//           <h3 className="text-2xl font-bold text-white mb-4">Verified by SPOCs</h3>
//           <p className="text-gray-300 mb-6">Our Single Point of Contact verification ensures transparency and accountability</p>
          
//           <ul className="space-y-3">
//             {["Independent verification", 
//               "Photo documentation", 
//               "Metrics tracking", 
//               "Detailed implementation reports"].map((feature, i) => (
//               <li key={i} className="flex items-start">
//                 <div className="h-5 w-5 mt-0.5 mr-3 flex-shrink-0 rounded-full bg-gradient-to-br from-[#ff3131] via-[#ff7040] to-[#ff914d] flex items-center justify-center">
//                   <svg className="h-3 w-3 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
//                     <polyline points="20 6 9 17 4 12"></polyline>
//                   </svg>
//                 </div>
...
//       <div className="inline-flex items-center bg-[#313030] rounded-full px-6 py-3 text-white border border-[#414040] shadow-lg">
...
//         </span>
//         <span>Currently connecting <span className="font-bold">50+ colleges</span> with <span className="font-bold">30+ companies</span></span>
//       </div>
//     </div>
//   </div>
// </section>
...
//         {/* How It Works Section */}
// <section id="how-it-works" className="py-20 bg-[#262323]">
//   <div className="container mx-auto px-4">
//     <div className="text-center mb-16">
//       <h2 className="text-4xl font-bold text-white mb-4">
//         <span className="relative inline-block px-2">
...
//     <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
//       {/* Connection line */}
//       <div className="hidden md:block absolute top-1/3 left-0 w-full h-0.5 bg-gradient-to-r from-[#ff3131] to-[#ff914d] z-0"></div>
...
//               </svg>
//               <div className="absolute top-0 right-0 bg-gradient-to-br from-[#ff3131] to-[#ff914d] text-white h-6 w-6 rounded-full flex items-center justify-center text-xs font-bold -mt-1 -mr-1 shadow-lg">
//                 01
//               </div>
//             </div>
...
// {/* Metrics Visualization Section */}
// <section className="py-20 bg-[#313030]">
//   <div className="container mx-auto px-4">
//     <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
//       <div>
...
//           <span className="relative inline-block px-2">
//             Measurable Results
//             <span className="absolute inset-x-0 bottom-2 bg-gradient-to-r from-[#ff3131]/30 to-[#ff914d]/30 -z-10 h-3"></span>
//           </span>
//         </h2>
...
//           {/* Engagement Metrics */}
//           <div className="flex">
//             <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-[#ff3131] to-[#ff914d] flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
...
//             </div>
//             <div>
//               <h4 className="font-bold text-white mb-1">Engagement Metrics</h4>
//               <p className="text-gray-300">Track audience engagement, reach, impressions, and interactions</p>
//             </div>
//           </div>
          
//           {/* Financial Tracking */}
//           <div className="flex">
//             <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-[#ff914d] to-[#ff3131] flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
//               <svg className="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//                 <path d="M18 20V10M12 20V4M6 20v-6"></path>
//               </svg>
//             </div>
//             <div>
//               <h4 className="font-bold text-white mb-1">Financial Tracking</h4>
//               <p className="text-gray-300">Monitor sponsorship value, ROI, and budget allocation</p>
//             </div>
//           </div>
          
//           {/* Implementation Verification */}
//           <div className="flex">
//             <div className="h-12 w-12 rounded-lg bg-gradient-to-br from-[#ff3131] via-[#ff7040] to-[#ff914d] flex items-center justify-center mr-4 flex-shrink-0 shadow-lg">
//               <svg className="h-6 w-6 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//                 <path d="M20 7L9 18l-5-5M12 1v7l2 2"></path>
//               </svg>
//             </div>
//             <div>
//               <h4 className="font-bold text-white mb-1">Implementation Verification</h4>
//               <p className="text-gray-300">Photo evidence and third-party validation of deliverables</p>
//             </div>
//           </div>
//         </div>
      
//         <div className="flex gap-8 mt-10">
//           <a href="/college" className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-[#ff3131] to-[#ff914d] text-white font-medium rounded-lg shadow-lg hover:shadow-xl transform transition-all hover:-translate-y-1 group">
//             Explore College 
//             <svg className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//               <path d="M5 12h14M12 5l7 7-7 7"></path>
//             </svg>
//           </a>
          
//           <a href="/company" className="inline-flex items-center justify-center px-6 py-3 bg-[#2c2b2b] text-[#ff914d] border border-[#ff914d] font-medium rounded-lg shadow-lg hover:bg-[#ff914d] hover:text-white transform transition-all hover:-translate-y-1 group">
//             Explore Company 
//             <svg className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
//               <path d="M5 12h14M12 5l7 7-7 7"></path>
//             </svg>
...
//       {/* Metrics Visualization */}
//       <div className="bg-[#262323] rounded-xl shadow-2xl p-8 relative border border-[#414040]">
//         <div className="bg-gradient-to-br from-[#ff3131]/10 to-[#ff914d]/10 absolute top-0 right-0 w-32 h-32 rounded-bl-3xl"></div>
        
//         <div className="relative z-10">
//           <h3 className="text-xl font-bold text-white mb-6">Sponsorship Performance Dashboard</h3>
          
//           {/* Dashboard mockup */}
//           <div className="bg-[#1e1c1c] border border-[#414040] rounded-lg overflow-hidden shadow-lg">
//             <div className="p-4 border-b border-[#414040]">
//               <div className="flex justify-between items-center">
//                 <div className="font-medium text-white">Techfest 2025 Metrics</div>
//                 <div className="flex space-x-2">
//                   <div className="h-3 w-3 rounded-full bg-[#ff3131]"></div>
//                   <div className="h-3 w-3 rounded-full bg-[#ff7040]"></div>
//                   <div className="h-3 w-3 rounded-full bg-[#ff914d]"></div>
//                 </div>
//               </div>
//             </div>
...
//               <div className="mb-6">
//                 <div className="flex justify-between items-center mb-2">
//                   <div className="text-sm font-medium text-gray-300">Engagement Metrics</div>
//                   <div className="text-xs text-gray-400">Last 30 days</div>
//                 </div>
//                 <div className="h-32 w-full bg-[#262323] rounded-lg p-3 flex items-end space-x-1 border border-[#414040]">
//                   {[35, 50, 30, 70, 45, 65, 55, 40, 50, 75, 60, 50, 65, 35].map((height, i) => (
//                     <div 
//                       key={i} 
//                       className="h-full flex-1 flex flex-col justify-end"
//                     >
//                       <div 
//                         className="bg-gradient-to-t from-[#ff3131] to-[#ff914d] rounded-t transition-all duration-500"
//                         style={{ height: `${height}%` }}
//                       ></div>
//                     </div>
//                   ))}
...
//                   { label: "Conversion", value: "3.2%", change: "+0.8%" }
//                 ].map((metric, index) => (
//                   <div key={index} className="bg-[#262323] rounded-lg p-3 border border-[#414040]">
//                     <div className="text-xs text-gray-400 mb-1">{metric.label}</div>
//                     <div className="flex items-end justify-between">
//                       <div className="text-xl font-bold text-white">{metric.value}</div>
//                       <div className="text-xs text-[#ff914d]">{metric.change}</div>
//                     </div>
//                   </div>
//                 ))}
//               </div>
...
//               {/* Sponsor breakdown */}
//               <div className="mt-6">
//                 <div className="text-sm font-medium text-gray-300 mb-2">Sponsor Breakdown</div>
//                 <div className="space-y-2">
//                   {[
//                     { name: "Gold Sponsors", value: 45, color: "bg-gradient-to-r from-[#ff914d] to-[#ff7a30]" },
//                     { name: "Silver Sponsors", value: 30, color: "bg-gradient-to-r from-[#ff7040] to-[#ff5040]" },
//                     { name: "Bronze Sponsors", value: 25, color: "bg-gradient-to-r from-[#ff5040] to-[#ff3131]" }
//                   ].map((tier, index) => (
//                     <div key={index} className="flex items-center">
//                       <div className="w-24 text-xs text-gray-400">{tier.name}</div>
//                       <div className="flex-1 h-2 bg-[#414040] rounded-full overflow-hidden">
//                         <div 
//                           className={`h-full ${tier.color}`} 
//                           style={{ width: `${tier.value}%` }}
//                         ></div>
//                       </div>
//                       <div className="w-8 text-xs text-gray-400 text-right">{tier.value}%</div>
//                     </div>
//                   ))}
//                 </div>
//               </div>
